...
function isMtpAudience(aud) {
  ...
  return (
    ...
    a.includes("api-eu.security.microsoft.com") ||
    a.includes("api-uk.security.microsoft.com") ||
    a.includes("api-us.security.microsoft.com") ||
    a.includes("api-au.security.microsoft.com") ||
    a.includes("api-in.security.microsoft.com")
  );
}
